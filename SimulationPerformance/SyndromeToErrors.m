...
%stabilisers and rows different single qubit errors (error syndromes for single qubit errors).
%The double_error_table is a 3-D array with first dimension being the first
%qubit errors, the second being the syndromes and the third the second
%qubit errors.
% syndrome_vec -        row vector with measured stabiliser outcomes, each entry
...
%errors on the qubits i and j. Then a row vector of zeros with 1's at i and
